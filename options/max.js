    ...
    switch (type) {
        case `Number`:
            ...
            if (value > optionValue) {
                result = `${inArray ? `Array element in field` : `Field`} '${path}' must be more than '${optionValue.toString()}'. '${value.toString()}' given.`
            }
            break
        case `BigInt`:
            ...
            if (value > BigInt(optionValue)) {
                result = `${inArray ? `Array element in field` : `Field`} '${path}' must be more than '${optionValue.toString()}'.`
            }
            break
    }

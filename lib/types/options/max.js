        ...
        switch (fieldValueType) {
            case `Number`:
                if (fieldOptionValueType !== `Number`) {
                    result = `Field '${fieldPath}', 'isNumber' contain incorrect option 'max'. Value of 'max' must be type of 'Number'. '${fieldOptionValueType}' given.`
                }
            ...
            case `BigInt`:
                if (fieldOptionValueType !== `String`) {
                    result = `Field '${fieldPath}', 'isBigInt' contain incorrect option 'max'. Value of 'max' must be type of 'String' because this is 'BigInt'. '${fieldOptionValueType}' given.`
                }
                ...
                break
            default:
                result = `Field '${fieldPath}' contain incorrect option 'max'.`
                break
        }
